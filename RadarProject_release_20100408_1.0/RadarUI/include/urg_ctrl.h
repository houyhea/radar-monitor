...
/*!
  ...
  $Id: urg_ctrl.h 411 2008-12-22 05:48:43Z satofumi $
...
enum {
  ...
  UrgInfinityTimes = 0,         /*!< MD/MS コマンドにおけるデータ取得回数 */
};
...
typedef enum {
  URG_GD,                       /*!< GD コマンド */
  URG_GD_INTENSITY,             /*!< GD コマンド(Intensity 付き) */
  URG_GS,                       /*!< GS コマンド */
  URG_MD,                       /*!< MD コマンド */
  URG_MD_INTENSITY,             /*!< MD コマンド(Intensity 付き) */
  URG_MS,                       /*!< MS コマンド */
} urg_request_type;
...
enum {
  ...
  UrgInvalidTimestamp = -1,		/*!< 無限回数のデータ取得 */
};
...
/*!
  ...
  \attention バッファ１行の長さは、65 byte 以上でなければならない
...
/*!
  ...
  \attention モータ速度が 100% 指定のときの１スキャンの計測時間を返す
...
/*!
  ...
  取得データの間引きを行い、取得データ量を減少させる。

  \param[in,out] urg URG 制御の構造体
  \param[in] lines 取得データの間引き数
...
/*!
  ...
  \bug 範囲全体のデータ取得をした場合でないと、結果が正しくない
...
/*!
  ...
  \param[in,out] urg URG 制御の構造体
  \param[in] speed_percent percent モータの回転速 [%]
